...
export default function ReplyToPost() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Upload image to backend-multer if selected
      if (imageFile) {
        try {
          ...
          if (!uploadResp.ok) {
            ...
            throw new Error(
              `Failed to upload image: ${uploadResp.status} - ${text}`
            );
          }

          const uploadData: { imagePath: string | null } =
      ...
      // No image selected — create reply directly
